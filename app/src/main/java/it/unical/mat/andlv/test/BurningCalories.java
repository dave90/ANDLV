...
public class BurningCalories {
    public static final String program="#maxint=1000.\n" +
            ...
            "remaining_calories_to_burn(RC) :- calories_to_burn(CTB), total_burnt_calories(TBC), RC = CTB - TBC.\n" +
            "how_long_max(A, MHL) :- remaining_calories_to_burn(RC), calories_burnt_per_activity(A, TNTB), MHL = RC / TNTB.\n" +
            "how_long(A, S) :- calories_burnt_per_activity(A, _), step(S).\n" +
            "step(5).\n" +
